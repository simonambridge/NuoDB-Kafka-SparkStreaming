...
class produceTransactions(brokers: String, topic: String) extends Actor {
  ...
  object kafka {
    val producer = {
      ...
      props.put("bootstrap.servers","localhost:9092"); /* new */
      props.put("key.serializer","org.apache.kafka.common.serialization.StringSerializer");/* new */
      props.put("value.serializer","org.apache.kafka.common.serialization.StringSerializer");/* new */
...
/*       new KeyedMessage[String, String](topic, str) */
         new ProducerRecord[String, String](topic, str)
      }
...
/*      kafka.producer.send(messages: _*) */
  ...
  def createTransaction () : String = {
    ...
    println("cc_no=",cc_no," txn_time=",txn_time, " items=",items, " amount=",amount)
